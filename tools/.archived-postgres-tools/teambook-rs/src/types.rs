...
pub struct Note {
    pub id: i32,  // Auto-generated by database
    pub ai_id: String,
...
pub struct Message {
    pub id: i32,  // Auto-generated by database
    pub from_ai: String,
    pub to_ai: Option<String>,  // None = broadcast
    pub timestamp: DateTime<Utc>,
    pub content: String,
    pub channel: String,
...
pub struct FileClaim {
    ...
    pub operation: String,  // "editing", "reading", etc.
}
...
/// A detangle session (simplified for awareness)
#[derive(Debug, Clone)]
pub struct DetangleInfo {
    pub id: i32,
    pub topic: String,
}
...
pub struct AwarenessData {
    ...
    pub votes: Vec<Vote>,
    pub detangles: Vec<DetangleInfo>,
    pub locks: Vec<LockInfo>,
}

impl Default for DetangleInfo {
    fn default() -> Self {
