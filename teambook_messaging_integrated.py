...
try:
    from teambook_pubsub import publish_broadcast as _publish_broadcast_event
    from teambook_pubsub import publish_direct_message as _publish_dm_event
    _REDIS_AVAILABLE = True
except ImportError:
    _REDIS_AVAILABLE = False
    _publish_broadcast_event = None
    _publish_dm_event = None
    ...
    try:
        ...
        for msg_id, from_ai, content, created in messages:
            ...
            parts = [
                ...
                content[:500]  # Preview (500 chars for context)
            ]
